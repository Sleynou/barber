...
const AccueilClient = () => {
    ...
    return (
        <div>
            ...
            <Container text style={{ flex: '1', background: '#4e2205', height: '100vh'  }}>
                <Header
                    as='h1'
                    ...
                    style={{
                        ...
                        textShadow: '2px 2px 2px rgb(53 238 255)',
                        color: 'white',
                        paddingTop: '0.5em'
                    }}
                />
                <Header
                    ...
                    style={{ fontSize: '2.5em', fontWeight: 'normal', marginTop: '2em', color: 'rgb(211 239 253)',  }}
                />
                <Header
                    as='h3'
                    ...
                    inverted
                    style={{ fontSize: '1.5em', fontWeight: 'normal', marginTop: '4em', color:'rgb(211 239 253)' }}
                />
            </Container>
        </Segment>
        ...
        <Segment vertical style={{ minHeight: '50vh', padding: '4em 0em', background: 'rgb(229 185 156)', display: 'flex', alignItems: 'center' }}>
            <Container textAlign="center">
