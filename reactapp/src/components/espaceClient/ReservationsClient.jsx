                ...
                <Table.Row key={index}>
                  <Table.Cell>
                    <Form>
                      ...
                      <Form.Field>
                        <Label>Date:</Label>
                        <Input fluid type='date' value={editedReservations[index]?.dateRDV || reservation.dateRDV} onChange={(e) => handleDateChangeInput(index, e.target.value)}  disabled={!editable} />
                      </Form.Field>
                      <Form.Field>
                        <Label>Heure:</Label>
                        {console.log(editedReservations)}
                        <Input value={editedReservations[index]?.heure || reservation.heure} onChange={(e) => handleHeureChange(index, e.target.value)} disabled={!editable} />
                      </Form.Field>
                      <Form.Field>
                        <Label>Durée:</Label>
